	...
	<div class="container">
		<form action="UpdateProduit.do" method="post">
			...
			<tr>
				...
				<td>
					<input type="text" name="nom" value="${ p.nom }" class="form-control" required="required">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="prix" value="${ p.prix }" class="form-control" required="required">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="quantite" value="${ p.quantite }" class="form-control" required="required">
				</td>
			</tr>
			</table>
