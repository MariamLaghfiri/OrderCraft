		...
		<table class="table">
			<thead>
				<tr>
					...
					<th><a href="AjouterProduit.do" class="btn btn-dark">Ajouter</a></th>
					<th><a href="SearchProduit.do" class="btn btn-dark">Rechercher</a></th>
				</tr>
				<tr>
					<th scope="col">Nom</th>
			...
			<tbody>
				<c:forEach var="p" items="${model.produits}">
					<tr>
						...
						<td><a href="EditProduit.do?id=${ p.id }" class="btn btn-dark">Edit</a></td>
						<td><a onclick="return confirm('Êtes-vous sûr ?')" href="SupprimerProduit.do?id=${ p.id }" class="btn btn-dark">Supprimer</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
