	...
	<div class="container">
		<form action="UpdateClient.action" method="post">
			...
			<tr>
				...
				<td>
					<input type="text" name="nom" value="${ c.nom }" class="form-control" required="required">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="adresse" value="${ c.adresse }" class="form-control" required="required">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="telephone" value="${ c.telephone }" class="form-control" required="required">
				</td>
			</tr>
			</table>
